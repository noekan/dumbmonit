<script lang="ts">
	/**
	 * Settings → Notifications: the channel list, and the add/edit form that
...
<Panel id="notifications" title="Notifications" description="Where DumbMonit tells you when something needs attention." padded={false}>
	{#snippet aside()}
		{#if !auth.isAdmin}
