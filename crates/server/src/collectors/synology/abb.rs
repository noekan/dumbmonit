...
mod tests {
    use super::*;
    use crate::collectors::synology::model::Envelope;
...
///
/// Le serveur ci-dessous reproduit les réponses Active Backup du faux DSM du
/// laboratoire (`docker/lab/fakes/synology.py`, scénario `abb-fail`) : trois tâches
/// — un PC, des machines virtuelles, un serveur de fichiers — dont la seconde
/// échoue depuis trois nuits. C'est le même parcours que celui du laboratoire,
...
mod lab_tests {
    ...
    const PASSWORD: &str = "lab-password";
    ...
    /// `task_id → (nom, type de source, appareils)`, comme dans le faux du laboratoire.
    ...
    #[tokio::test]
    async fn les_trois_taches_du_laboratoire_sont_mesurees() {
